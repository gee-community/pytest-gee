...
**pytest-gee** uses `nox <https://nox.thea.codes/en/stable/>`__ to automate several development-related tasks.
...
This will install the **pytest-gee** library, together with two additional tools:
